      ...
      <main className={styles.main}>
        <section className={styles.head}>
          ...
          <a href="/about" className={styles.more}><BsDash/>More about me<BsArrowRight className={styles.move}/></a>
            ...
            <a href="https://drive.google.com/file/d/1zAAXx2w9W4BVSECKXkXjWfXerjrKHjNh/view?usp=sharing" target="_blank" className={styles.resume}><BsCloudDownload/>&nbsp; RESUME</a> 
          {/* </button> */}
        </section>
      </main>
    </>
